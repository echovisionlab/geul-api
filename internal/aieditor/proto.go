...
func domainFromProto(value managev1.AIDocumentDomain) (aidocument.Domain, bool) {
	domain, ok := map[managev1.AIDocumentDomain]aidocument.Domain{
		...
		managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_RELEASE:        aidocument.DomainRelease,
		managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_ARTIST:         aidocument.DomainArtist,
		managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_LABEL:          aidocument.DomainLabel,
...
func domainToProto(value aidocument.Domain) managev1.AIDocumentDomain {
	return map[aidocument.Domain]managev1.AIDocumentDomain{
		...
		aidocument.DomainRelease:       managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_RELEASE,
		aidocument.DomainArtist:        managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_ARTIST,
		aidocument.DomainLabel:         managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_LABEL,
