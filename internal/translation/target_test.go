...
func TestTargetCatalogIsCompleteAndBidirectional(t *testing.T) {
	...
	expected := []Definition{
		...
		{KindRelease, managev1.TranslationEntityType_TRANSLATION_ENTITY_TYPE_RELEASE, "release", "release_translation",
			managev1.ContentEntityType_CONTENT_ENTITY_TYPE_RELEASE},
		{KindArtist, managev1.TranslationEntityType_TRANSLATION_ENTITY_TYPE_ARTIST, "artist", "artist_translation",
			managev1.ContentEntityType_CONTENT_ENTITY_TYPE_ARTIST},
		{KindLabel, managev1.TranslationEntityType_TRANSLATION_ENTITY_TYPE_LABEL, "label", "label_translation",
