// Package series adapts Series persistence to shared capabilities.
package series
...
// Projection owns the current OG pointers and bindings for Series.
...
func (p *Projection) Complete(
	...
	if target.EntityType == "series" && locale == "" {
