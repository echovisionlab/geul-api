...
func interactiveContentEntityType(domain core.Domain) (managev1.ContentEntityType, error) {
	entityType, exists := map[core.Domain]managev1.ContentEntityType{
		...
		core.DomainRelease:       managev1.ContentEntityType_CONTENT_ENTITY_TYPE_RELEASE,
		core.DomainArtist:        managev1.ContentEntityType_CONTENT_ENTITY_TYPE_ARTIST,
		core.DomainLabel:         managev1.ContentEntityType_CONTENT_ENTITY_TYPE_LABEL,
