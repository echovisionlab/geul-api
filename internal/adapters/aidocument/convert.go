...
func domainFromProto(value managev1.AIDocumentDomain) (core.Domain, error) {
	mapping := map[managev1.AIDocumentDomain]core.Domain{
		...
		managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_RELEASE:        core.DomainRelease,
		managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_ARTIST:         core.DomainArtist,
		managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_LABEL:          core.DomainLabel,
...
func domainToProto(value core.Domain) managev1.AIDocumentDomain {
	mapping := map[core.Domain]managev1.AIDocumentDomain{
		...
		core.DomainRelease:       managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_RELEASE,
		core.DomainArtist:        managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_ARTIST,
		core.DomainLabel:         managev1.AIDocumentDomain_AI_DOCUMENT_DOMAIN_LABEL,
